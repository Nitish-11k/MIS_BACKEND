...
unparsed_files = [
  ...
  "InterestRateChangeLoans-cfpd0337.txt.gz",
  "Irregular_excess_draw_lond2397CPC.txt.gz",
  "LIST_OF_NPA_ACCOUNTS.txt.gz",
  "LoansBalanceFile-lond2390.txt.gz",
  "LOANS_SANCTION_LETTER_FOR_AC402000294534.txt.gz",
  "LOAN_IRREGULAR_REPORT.txt.gz",
  "non_home_branch_cifd0363.txt.gz",
  "Overdue_Notice_lond2384.txt.gz",
  "Probable_NPA_Report_lond2463.txt.gz",
  "Report_High_Value_Transactions.txt.gz",
  "Report_Maturing_Securities_lond2443.txt.gz",
  "RUPEE_DRAWING_LIST_cfpd0388.txt.gz",
  "Supplimentary_control_gend7484.txt.gz",
  "Supplimentary_control_gend7516.txt.gz",
  "Supplimentary_report_gend7484.txt.gz",
  "Transfer_Supplementary_gend7484.txt.gz",
  "Transfer_Supplementary_gend7516.txt.gz",
  "Voucher_varification_report_cfpd0331.txt.gz",
  "Voucher_varification_report_cfpd0344.txt.gz"
]
